...
namespace MironovLab.OvpnMonitor.Service.Logging
{
    ...
    public class Logger<T> : ILogger<T>
    {
        ...
        public Logger(ILoggerFactory factory, string hostName)
        {
            if (factory == null)
            {
            ...
            _logger = factory.CreateLogger(TypeNameHelper.GetTypeDisplayName(typeof(T), includeGenericParameters: false, nestedTypeDelimiter: '.')+':'+hostName);
        }
